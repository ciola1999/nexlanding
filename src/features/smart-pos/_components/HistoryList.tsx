...
import {
  ...
  MessageCircle,
  PieChart,
  Printer, // ✅ Pastikan Printer diimport
} from 'lucide-react';
import { cn } from '@/lib/utils';
// ✅ IMPORT 1: Import Dialog Component (Sesuaikan path folder kamu)
...
export default function HistoryList({ history }: { history: HistoryItem[] }) {
  ...
  // ✅ STATE 2: State untuk menghandle Dialog Reprint
  ...
  const handleOpenReprint = (e: React.MouseEvent, id: number) => {
    e.stopPropagation(); // 👈 Penting: Agar accordion tidak menutup saat klik tombol print
  ...
  return (
    <>
              ...
              >
                <div className="overflow-hidden">
                  <div className="bg-black/20 border-t border-dashed border-white/10 mx-0 sm:mx-4 mb-4 rounded-b-2xl px-4 pb-4">
                    ...
                    {/* ✅ TOMBOL REPRINT (Integration Point) */}
      ...
      {/* ✅ 3. RENDER DIALOG DI LUAR LOOPING */}
      <ReprintDialog
        open={reprintOpen}
